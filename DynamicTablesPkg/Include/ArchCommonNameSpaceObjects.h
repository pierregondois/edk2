...
typedef enum ArchCommonObjectID {
  ...
  EArchCommonObjProximityDomainInfo,            ///< 35 - Proximity Domain Info
  EArchCommonObjProximityDomainRelationInfo,    ///< 36 - Proximity Domain Relation Info
  EArchCommonObjSystemLocalityInfo,             ///< 37 - System Locality Info
  EArchCommonObjMemoryProximityDomainAttrInfo,  ///< 38 - Memory Proximity Domain Attribute
